...
- [ ] Controller 레이어에 대한 이해 및 웹 API 구현
- [ ] Postman 사용방식

## 기본 요구사항

- [ ] DiscodeitApplication의 테스트 로직은 삭제
- [ ] 지금까지 구현한 서비스 로직을 활용해 웹 API를 구현 이때, @RequestMapping만을 사용
- [ ] 웹 API의 예외를 전역으로 처리하세요.
- [ ] Postman을 활용해 컨트롤러를 테스트 및 Postman API 테스트 결과를 다음과 같이 export하여 PR에 첨부
...
- [ ] 사용자 목록 조회 API를 정적 리소스 화면과 연동
- [ ] BinaryContent 파일 조회 API 구현
- [ ] 제공된 정적 리소스를 활용하여 사용자 목록 화면 서빙

### 🤖 생성형 AI 활용

- [ ] 생성형 AI(ChatGPT, Claude 등)를 활용하여 사용자 목록 화면 구현
- [ ] 제공된 이미지와 유사한 UI를 생성하고 정적 리소스로 서빙
